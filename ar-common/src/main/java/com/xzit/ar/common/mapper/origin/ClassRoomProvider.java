...
public class ClassRoomProvider {
	...
	public String classDirectory(){
		return "select ui.qq qq, ui.phone phone, ui.email email, u.user_id userId, u.true_name trueName, "
				+ "ui.microblog microblog, ui.wechat wechat, ui.address address, img.image_path imgPath , uj.job_name jobName , uj.job_unit jobUnit "
				+ "from origin o, user_origin uo, user_info ui, image img, user u , user_job uj "
				+ "where o.origin_id=#{classId} and o.state='A' "
				+ "and uo.origin_id=o.origin_id and uo.state='A' and ui.user_id=uo.user_id and ui.user_id = uj.user_id "
