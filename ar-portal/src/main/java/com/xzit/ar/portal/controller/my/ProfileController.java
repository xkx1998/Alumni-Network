...
public class ProfileController extends BaseController {
    ...
    public String upload(HttpSession session, MultipartFile portrait, HttpServletRequest request) throws UtilException, ServiceException {
        // 参数校验
        if (portrait != null && portrait.getSize() > 0) {
            ...
            // 保存到硬盘
            String imagePath = ImageUtil.saveImage(portrait,request);
