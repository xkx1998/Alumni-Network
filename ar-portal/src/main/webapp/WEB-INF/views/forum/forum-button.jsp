...
<form action="forum.action" method="post">
	...
	<div class="input-group col-sm-3">
		...
		<input type="text" name="queryStr" id="queryStr" class="form-control col-xs-3" size="10" width="100px" value="${queryStr}"
			   placeholder="帖子/作者" onkeypress="if(event.keyCode==13){queryBtn.click();return false;}" />
