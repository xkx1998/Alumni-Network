									...
									<div class="blog-details">
										<h5 class="blog-title">
											<a href="${pageContext.request.contextPath}/orgroom.action?originId=${mass.originId}">
												<i class="fa fa-graduation-cap"></i> <ar:sub length="10" value="${mass.originName}" /></a>
										</h5>
										<ul class="blog-meta">
...
<script src="${pageContext.request.contextPath}/assets/script/org/org-union.js"></script>
</html>