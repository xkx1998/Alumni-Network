...
<html>
<head>
<title>${classroom.className}-莞工校友网</title>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="classroom-content">
				...
				<div class="col-md-3"
					...
					<div class="media">
						<a class="pull-left"
							href="${pageContext.request.contextPath}/ta/show.action?userId=${classroom.mgrId}">
							<img class="media-object img-responsive" src="${pageContext.request.contextPath}${classroom.mgrImg}"
