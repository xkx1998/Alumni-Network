...
<html>
<head>
    <title>${classroom.classGrade}级${classroom.className}-莞工校友网</title>
    ...
    <div class="tab-content" style="background-color: #ddd;">
        <div class="tab-pane active" id="classroom-content">
            <div class="row blog-content">
                <div class="col-sm-9">
                    <div class="panel panel-default panel-blog">
                        <div class="panel-body">
                            ...
                            <c:if test="${info.thumbImage!=null && info.thumbImage!=''}">
                                <br/>
                                <div class="blog-img">
                                    <img src="${info.thumbImage}" class="img-responsive center-block"/>
                                </div>
                            </c:if>
                            <br/>
                            <div class="mb10"></div>
                            ...
                            <input hidden id="classId" value="${classroom.classId}"/>
                            <div class="widget-photoday">
                                <ul class="photo-meta">
                                    ...
                                    <li><a href="javascript:;" onclick="loveInfo(${info.infoId})" id="info-love-add">
                                        ...
                                        <arp class="info-loves">${info.loves}</arp>
                                        )</a>
                                    </li>
                                    <li><a href="javascript:;" onclick="focusCommentInfo()"><i
                                            class="fa fa-comment"></i> 评论 (${info.comments})</a></li>
                                    <c:if test="${info.userId == SESSION_USER.userId}">
                                        <li><a href="javascript:;" onclick="deleteInfo(${info.infoId})"><i
                    ...
                    <div class="media">
                        <a class="pull-left" href="${pageContext.request.contextPath}/ta/show.action?userId=${info.userId}">
                            <img class="thumbnail img-responsive center-block" src="${pageContext.request.contextPath}${info.portrait}"
                    ...
                    <c:if test="${SESSION_USER != null}">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/classroom/commentInfo.action" id="form-comment">
                            ...
                            <input hidden name="classId" value="${classroom.classId}">
                            <div class="mb10"></div>
                            <button class="btn btn-primary" onclick="commentInfo()" type="button"><i
                ...
                <div class="col-sm-3" id="classroom-info-side">
