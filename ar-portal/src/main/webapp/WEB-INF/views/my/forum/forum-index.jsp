                    ...
                    <table class="table table-hover mb20">
                        ...
                        <c:forEach items="${page.beanList}" var="post">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-xs" href="${pageContext.request.contextPath}/post/detail.action?postId=${post.infoId}">详情</a>
...
<script src="${pageContext.request.contextPath}/assets/script/my/forum/forum-index.js"></script>
</html>