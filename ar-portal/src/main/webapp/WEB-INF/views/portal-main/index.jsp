...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active"><img src="${pageContext.request.contextPath}/assets/images/school/dgut-4.jpg"></div>
        <div class="item"><img src="${pageContext.request.contextPath}/assets/images/school/dgut-2.jpg"></div>
        <div class="item"><img src="${pageContext.request.contextPath}/assets/images/school/dgut-3.jpg"></div>
        <div class="item"><img src="${pageContext.request.contextPath}/assets/images/school/dgut-5.jpg"></div>
        <div class="item"><img src="${pageContext.request.contextPath}/assets/images/school/dgut-6.jpg"></div>
    </div>
    <!-- 轮播（Carousel）导航 -->
